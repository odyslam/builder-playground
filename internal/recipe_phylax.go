...
type OpTalosRecipe struct {
	...
	// externalDA is the URL of the external DA to use. If unset or set to "dev", the recipe
	// will deploy a new assertion-da service and connect it to the external DA.
	externalDA string
	...
	// If set to true, the recipe will deploy a new eth-faucet service
	faucet bool
